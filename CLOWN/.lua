...
T1:AddToggle({
    ...
    Callback = function(val)
        ...
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(game:GetService("Workspace").NPC[_G.NPCtrigger][randomizer].HumanoidRootPart.Position)
      end
  end
})
